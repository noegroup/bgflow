...
project = 'bgflow'
copyright = ("2021, noegroup. Project structure based on the "
...
latex_documents = [
    (master_doc, 'bgflow.tex', 'bgflow Documentation',
     'bgflow', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'bgflow', 'bgflow Documentation',
     author, 'bgflow', 'Boltzmann Generators and Normalizing Flows in PyTorch',
     'Miscellaneous'),
]
