...
from ..nn.flow.transformer.compact.compact import MixtureCDFTransformer, AffineSigmoidComponents, SmoothRamp
from ..nn.flow.root_finding.approx_inverse import GridInversion, WrapCDFTransformerWithInverse
...
def _make_sigmoid_transformer(
    ...
    transformer = WrapCDFTransformerWithInverse(
        transformer=transformer,
        oracle=GridInversion( #bg.BisectionRootFinder(
            transformer=transformer,
