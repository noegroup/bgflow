...
class UmbrellaSampling(object):
    ...
    def __init__(self, energy_function, sampler, rc_function, x0,
        ...
        self.umbrellas = [UmbrellaModel(energy_function, rc_function, k, m) for m in m_umbrella]
    ...
    def run(self, nsteps=10000, verbose=True):
        ...
        for i in range(len(self.umbrellas)):
            ...
            self.sampler.energy_function = self.umbrellas[i]  # this is a hot fix - find a better way to do this.
    ...
    def mbar(self, rc_min=None, rc_max=None, rc_bins=50):
        ...
        mbar_obj = pyemma.thermo.estimate_umbrella_sampling(self.rc_trajs, dtrajs,
